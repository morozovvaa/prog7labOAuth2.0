...
### Выполнение Authorization Code Flow
...
1.  **Настройка:** Были установлены специализированные библиотеки Google Auth (`google-auth-oauthlib`) и зарегистрировано новое OAuth-приложение в Google Cloud Console.
